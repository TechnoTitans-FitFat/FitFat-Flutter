...
class WheatScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: const CustomAppBar(title: 'Wheat'),
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              BlocConsumer<WheatCubit, WheatState>(
                listener: (context, state) {},
                builder: (context, state) {
                  if (state is WheatLoading) {
                    return const Center(
                      child: CircularProgressIndicator(),
                    );
                  } else if (state is WheatFailure) {
                    return Center(
                      child: Text(
                        state.errMessage,
                        style:
